    ...
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        >
          ...
          <h2 className="text-2xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-surface drop-shadow-lg shrink-0">
            Device History
          </h2>
            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {logs.map((log) => (
                  <div
                    key={log.id}
                    className="bg-surface/60 rounded-lg p-3 border border-blue-400/20"
                  >
                    <div className="flex justify-between items-start mb-1">
                      <span className="font-bold text-primary text-sm">{log.action}</span>
