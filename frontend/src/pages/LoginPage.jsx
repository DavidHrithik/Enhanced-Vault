...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-bg-end/90 via-surface/95 to-bg-start/90 relative overflow-hidden border border-surface/60 shadow-2xl backdrop-blur-xl">
      {/* Animated Background */}
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-4 min-h-screen w-full">
        ...
        <motion.div
          ...
          style={{
            ...
            background:
              'linear-gradient(120deg, rgba(35,41,70,0.20) 40%, rgba(23,22,28,0.12) 100%)',
          }}
        >
          <h2 className="text-3xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-[#7ea4c7] animate-gradient text-center drop-shadow-lg">
