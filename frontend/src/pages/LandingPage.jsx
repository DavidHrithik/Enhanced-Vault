...
export default function LandingPage() {
  // Force rebuild - Dashboard tile removed
          ...
          <div className="flex flex-wrap gap-12 mt-8 justify-center">
            ...
            <motion.div
              whileHover={{
                scale: 1.04,
                rotate: -8,
                boxShadow: '0 8px 32px 0 rgba(93, 188, 252, 0.18)',
                background: 'rgba(40,60,90,0.22)',
              }}
              whileTap={{ scale: 0.98 }}
              transition={{ type: 'spring', stiffness: 300, damping: 22 }}
              className="w-72 h-60 bg-surface/16 backdrop-blur-xl border border-primary/30 shadow-xl rounded-2xl flex flex-col items-center justify-center cursor-pointer transition-all duration-200 hover:border-primary/60 focus:outline-none"
              style={{
                marginRight: 24,
              ...
              >
                <motion.svg
                  ...
                  whileHover={{
                    scale: 1.18,
                    rotate: 8,
                    filter: 'drop-shadow(0 0 12px rgb(var(--primary)))',
                  }}
                >
                  <motion.rect
                    x="18"
                ...
                <span className="text-2xl font-extrabold mb-1 bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-[#7ea4c7] animate-gradient">
            ...
            <motion.div
              whileHover={{
                scale: 1.04,
                rotate: 8,
                boxShadow: '0 8px 32px 0 rgba(93, 252, 188, 0.18)',
                background: 'rgba(40,60,90,0.22)',
              }}
              whileTap={{ scale: 0.98 }}
              transition={{ type: 'spring', stiffness: 300, damping: 22 }}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <rect x="30" y="20" width="4" height="4" rx="1" fill="rgb(var(--primary))" />
                  <motion.rect
                    x="16"
                    y="36"
                    width="32"
                ...
                <span className="text-2xl font-extrabold mb-1 bg-clip-text text-transparent bg-gradient-to-r from-[#5fd7b7] via-primary to-secondary animate-gradient">
                  {config.DHQ_TILE_NAME || 'D.H.Q.'}
                </span>
                <span className="text-base font-semibold text-green-200 mb-2">
                  Device Head Quarters
                </span>
              </Link>
            </motion.div>
            ...
            {isAdmin && (
              <motion.div
                whileHover={{
                  scale: 1.04,
                  rotate: -8,
                  boxShadow: '0 8px 32px 0 rgba(255, 99, 132, 0.18)',
                  background: 'rgba(40,60,90,0.22)',
                }}
                whileTap={{ scale: 0.98 }}
                transition={{ type: 'spring', stiffness: 300, damping: 22 }}
